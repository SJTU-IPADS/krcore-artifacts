...
DEFINE_string(gids, "fe80:0000:0000:0000:ec0d:9a03:00ca:31d8 fe80:0000:0000:0000:ec0d:9a03:0078:649a", "gid list"); // split by one blank
usize
...
worker_fn(const usize &worker_id, Statics *s) {
    ...
    for (int i = 0; i < FLAGS_or_sz; ++i) {
        ...
        req_list[i] = {
                ...
                .send_flags = i == 0 ? 1 : 0,
                .vid = worker_id,
                .type = FLAGS_rdma_op == 0 ? Read : Write,
        };
    }
