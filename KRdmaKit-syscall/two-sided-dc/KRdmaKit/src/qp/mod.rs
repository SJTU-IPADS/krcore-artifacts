...
impl Config {
    ...
    pub fn set_max_send_wr_sz(mut self, new_v: usize) -> Self {
        self.max_send_wr_sz = min(self.max_cqe, new_v);
        self
    }

    #[inline]
    pub fn set_max_recv_wr_sz(mut self, new_v: usize) -> Self {
        self.max_recv_wr_sz = min(self.max_recv_cqe, new_v);
        self
    }
    ...
    pub fn set_max_cqe(mut self, new_v: usize) -> Self {
        self.max_cqe = max(self.max_send_wr_sz, new_v);
        self
    }

    #[inline]
    pub fn set_max_recv_cqe(mut self, new_v: usize) -> Self {
        self.max_recv_cqe = max(self.max_recv_wr_sz, new_v);
        self
    }
}
...
#[inline]
pub(crate) fn create_ib_cq(dev: *mut ib_device, cq_attr: *mut ib_cq_init_attr) -> *mut ib_cq {
